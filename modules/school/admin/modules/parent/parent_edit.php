...
$form->edit->input->name->setRequire($require = 'text', $is_mandatory = 1);
...
$form->edit->addInput('profession', 'text');
$form->edit->input->profession->setTitle('profesi orangtua');
$form->edit->input->profession->setRequire($require = 'text', $is_mandatory = 1);
...
$form->edit->input->nokk->setRequire($require = 'number', $is_mandatory = 1);

$form->edit->addInput('nik', 'text');
$form->edit->input->nik->setTitle('nik');
$form->edit->input->nik->setRequire($require = 'number', $is_mandatory = 1);
$form->edit->action();
