...
if ($show_list) {
    $position = array('Kepala Sekolah', 'Wakil Kepala Sekolah', 'Guru Pengajar', 'Staff', 'Tukang Kebun');
...
?>
    ...
    <a href="<?php echo site_url('school/teacher_add') ?>">
        <button type="button" class="btn btn-info" style="margin: 0px 0px 20px 10px ">Tambah Guru</button>
    </a>
