...
$form->edit->addInput('gender', 'radio');
$form->edit->input->gender->setTitle('Pilih Gender');
$form->edit->input->gender->addRadio('Laki-Laki', 1);
$form->edit->input->gender->addRadio('Perempuan', 2);
