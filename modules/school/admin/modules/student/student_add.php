...
$fields = [
    'B' => 'nama_siswa',
    'C' => 'gender',
    'D' => 'tanggal_lahir_siswa',
    'E' => 'nis',
    'F' => 'nisn',
    'G' => 'nomer_kk',
    'H' => 'alamat',
    'I' => 'nama_ayah',
    'J' => 'tanggal_lahir_ayah',
    'K' => 'profesi_ayah',
    'L' => 'nik_ayah',
    'M' => 'nomer_telepon_ayah',
    'N' => 'nama_ibu',
    'O' => 'tanggal_lahir_ibu',
    'P' => 'profesi_ibu',
    'Q' => 'nik_ibu',
    'R' => 'nomer_telepon_ibu',
    'S' => 'nama_wali',
    'T' => 'tanggal_lahir_wali',
    'U' => 'profesi_wali',
    'V' => 'nik_wali',
    'W' => 'nomer_kk_wali',
    'X' => 'nomer_telepon_wali',
    'Y' => 'alamat_wali',
];
$data_user = 0;
$data_siswa = 0;
if (isset($fields['E']) && !empty($_POST[$fields['E']])) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['manual']) && !empty($_POST[$fields['E']]) && !$data_siswa && !$data_user) {
        ...
        if (!empty($value[$insert_field['nama_siswa']]) && $data_siswa == 0 && $data_user_id == 0) {
            ...
            if (!empty($value[$insert_field['nama_ayah']]) && $data_ayah == 0) // INSERT DATA AYAH
            {
                ...
                $ayah_parent_id_file = $db->Insert('school_parent', array(
                    ...
                    'profession' => $value[$insert_field['profesi_ayah']],
            ...
            if (!empty($value[$insert_field['nama_ibu']]) && $data_ibu == 0) // INSERT DATA IBU
            {
                ...
                $ibu_parent_id_file = $db->Insert('school_parent', array(
                    ...
                    'profession' => $value[$insert_field['profesi_ibu']],
            ...
            if (!empty($value[$insert_field['nama_wali']]) && $data_wali == 0) // INSERT DATA WALI
            {
                ...
                $wali_parent_id_file = $db->Insert('school_parent', array(
                    ...
                    'profession' => $value[$insert_field['profesi_wali']],
