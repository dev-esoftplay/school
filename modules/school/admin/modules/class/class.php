...
<?php
	...
	$form->search->input->grade->setTitle('Sortir Kelas');
	$form->search->input->grade->addOption(['1', '2', '3', '4', '5', '6']);

	$form->search->addInput('keyword', 'keyword');
	//TODO: Suspect search error
	$form->search->input->keyword->addSearchField('grade,major,label');
	$form->search->input->keyword->setDefaultValue('');
