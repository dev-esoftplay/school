  ...
  <form action="" method="POST" class="form" role="form">
    <div class="panel panel-default">
      ...
      <div class="panel-footer col-md-12" style="display: flex; justify-content: space-between;">
          ...
          <form action="" method="POST" class="form" role="form">
          <button type="submit" name="delete" value="remove" class="btn btn-danger col-md-5" onclick="if (confirm('Are you sure you want to delete this data?')) { return true; } else { return false; }">                  <span class="glyphicon glyphicon-trash"></span> Hapus Data Semester Lalu
              </button>
          </form>
      </div>
    </div>
