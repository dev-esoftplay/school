...
<head>
  ...
  <style>
    .custom-blue {
      background-color: rgba(8, 86, 170, 0.94) !important;
      color: white;
    }
  </style>
...
<body>
  ...
  <div class="header d-flex align-items-center justify-content-between bg-white p-3 px-4 mb-4 shadow-sm">
    <a href="teacher/class" onclick="redirectAndClose(event, 'score.php')" class="fs-3 text-decoration-none text-dark cursor-pointer"><i class="fas fa-arrow-left"></i> Kembali</a>
