...
<body>
    ...
    <script type="text/javascript">
        if (_URL.indexOf(window.location.protocol) == -1)
            window.location.href = window.location.href.replace(window.location.protocol, (window.location.protocol == 'https:') ? 'http:' : 'https:');
    </script>
