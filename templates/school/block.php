	...
	<div class="container">
		<div class="row">
			<div class="col-lg-9 col-md-9 col-sm-9 probootstrap-top-quick-contact-info">
				...
				<span><i class="icon-phone2"></i>+62 898-5513-453</span>
              ...
              <div class="owl-carousel owl-carousel-testimony owl-carousel-fullwidth">
                <div class="item">
                  ...
                  <div class="probootstrap-testimony-wrap text-center">
                    ...
                    <blockquote class="quote">“Design must be functional and functionality must be translated into visual aesthetics, without any reliance on gimmicks that have to be explained.” <cite class="author"> — <span>Mike Fisher</span></cite></blockquote>
                  </div>
