...
export default function m(props: ScanAttendenceProps): any {
    ...
    //  data: data , schedule_id: schedule_id, class_id: class_id, course_id: course_id
    // <View style={{flex:1,marginTop:LibStyle.STATUSBAR_HEIGHT}}>
    //    <Text>link Qr: {data}</Text>
    //       <Text>schedule_id: {schedule_id}</Text>
    //         <Text>class_id: {class_id}</Text>
    //         <Text>course_id: {course_id}</Text>
    // </View>
