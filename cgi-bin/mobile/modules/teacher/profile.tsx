...
function m(props: TeacherProfileProps): any {
    const [ParentStudent, setParentStudent] = React.useState<any>([])
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FFFFFF', }}>
            <View style={{ height: LibStyle.height / 2.5, backgroundColor: '#136B93', justifyContent: 'flex-start', alignItems: 'center', padding: 30, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, ...elevation(6) }}>
                <Image source={{ uri: ParentStudent?.image ?? 'https://images.unsplash.com/photo-1507823782123-27db7f9fd196?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }} style={{ width: 135, height: 135, borderRadius: 135 / 2, borderWidth: 3, borderColor: '#FFFFFF' }} />
                <View>
                    <Text style={{ color: '#FFFFFF', fontWeight: 'bold', fontSize: 25, textAlign: 'center', padding: 10 }}>{ParentStudent?.name ?? 'name'} </Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, marginHorizontal: 20 }}>
                    ...
                    <TouchableOpacity disabled={true} style={{ flex: 1, paddingVertical: 10, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', borderRadius: 10, marginLeft: 10 }}>
                        <Text style={{ color: '#000000', fontSize: 15, fontWeight: 'bold' }}>{ParentStudent?.class_name ?? 'nama kelas'}</Text>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <View style={{ alignItems: 'center', marginTop: 15 }}>
                <Pressable onPress={() => { LibNavigation.navigate('teacher/myclass', { clasid: ParentStudent?.class_id }) }} style={{ height: 55, width: LibStyle.width - 25, backgroundColor: '#136B93', justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', borderRadius: 15, paddingHorizontal: 20 }}>
            ...
            <View style={{ alignItems: 'center', marginTop: 15 }}>
                <Pressable onPress={() => logout()} style={{ height: 55, width: LibStyle.width - 25, backgroundColor: '#136B93', justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', borderRadius: 15, paddingHorizontal: 20 }}>
