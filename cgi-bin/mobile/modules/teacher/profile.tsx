    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FFFFFF', }}>
            <View style={{ height: LibStyle.height / 2.5, backgroundColor: '#136B93', justifyContent: 'flex-start', alignItems: 'center', padding: 30, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, ...elevation(6) }}>
                <Image source={{ uri: resApi.image ?? 'https://images.unsplash.com/photo-1507823782123-27db7f9fd196?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }} style={{ width: 135, height: 135, borderRadius: 135 / 2, borderWidth: 3, borderColor: '#FFFFFF' }} />
                <View>
                    <Text style={{ color: '#FFFFFF', fontWeight: 'bold', fontSize: 25, textAlign: 'center', padding: 10 }}>{resApi?.name ?? 'name'} </Text>
                </View>
