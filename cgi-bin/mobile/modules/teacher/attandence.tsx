      ...
      <FlatList data={studentListAttandence ?? []}
        ...
        renderItem={
          ({ item, index }) => {
            ...
            return (
              <Pressable onPress={() => { setPopupVisible(true), setstudentId(item.student_id), setstudentName(item?.name) }} style={{ flexDirection: 'row', justifyContent: 'flex-start', marginTop: 10, alignItems: 'center', borderColor: getStudentColor(item?.status), borderWidth: 3, borderRadius: 12, height: 90 }}>
