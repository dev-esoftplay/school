            ...
            StudentDetailAttendance?.schedule_day?.map?.((items: any) => {
              return (
                ...
                <View style={{ marginVertical: 10, backgroundColor: '#0DBD5E', borderRadius: 10, ...elevation(4), padding: 2, justifyContent: 'center' }}>
                  <View style={{ flexDirection: 'row', width: LibStyle.width * 0.9 - 4, height: LibStyle.height * 0.1 + 18, backgroundColor: '#FFFFFF', borderRadius: 10, justifyContent: 'space-between' }}>
                ...
                <View>
                  <LibList
                    ...
                    renderItem={(item: any) => (
                      ...
                      <View key={item.schedule_id} style={{ marginBottom: 10, backgroundColor: '#4B7AD6', borderRadius: 10, alignItems: 'flex-end', ...elevation(4),flex:1, paddingLeft:4,padding: 2.5, alignSelf: 'center' }}>
                        <View style={{ flex: 1, justifyContent: 'space-between', flexDirection: 'row', overflow: 'hidden', width: LibStyle.width * 0.9 - 5, height: LibStyle.height * 0.1 + 18, backgroundColor: '#FFFFFF', borderRadius: 10 }}>
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flex: 1, backgroundColor: '#4B7AD6', borderBottomRightRadius: 20, borderBottomLeftRadius: 20, padding: 20, paddingTop: 40 }}>
          ...
          <View style={{ backgroundColor: '#FFFFFF', height: 120, justifyContent: 'flex-start', alignItems: 'center', marginVertical: 20, padding: 15, flexDirection: 'row', borderRadius: 10 }}>
            ...
            <View style={{ marginLeft: 15, justifyContent: 'center', alignItems: 'flex-start' }}>
              <Text style={{ fontSize: 19, color: '#000000', textAlign: 'center', fontWeight: '600' }}>Nama: {childDataRaport?.student_name}</Text>
              <Text style={{ fontSize: 19, color: '#000000', textAlign: 'center', fontWeight: '600' }}>Kelas: {childDataRaport?.class_name}</Text>
              <Text style={{ fontSize: 19, color: '#000000', textAlign: 'center', fontWeight: '600' }}>NIS: {childDataRaport?.nis}</Text>
        ...
        <View style={{ marginLeft: 15, marginTop: 15 }}>
             <Text style={{ fontSize: 20, color: '#000000', fontWeight: '600'}}>Raport</Text>
        </View>
           <CustomCard number="1" title="10 PPLG 1" subtitle="Semester 1" />
           <CustomCard number="2" title="10 PPLG 2" subtitle="Semester 2" />
           <CustomCard number="3" title="11 PPLG 1" subtitle="Semester 1" />
           <CustomCard number="4" title="11 PPLG 2" subtitle="Semester 2" />
      </ScrollView>
